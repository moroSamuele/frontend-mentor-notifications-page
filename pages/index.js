                    ...
                    <div className="w-full rounded-xl bg-neutralWhite p-5">
                        ...
                        <div className="flex flex-col space-y-1 mt-5">
                            ...
                            <NotificationCard isNewNotification={false} image="avatar-rizky-hasanuddin.webp">
                                ...
                                <div className="mt-2 border-[1px] border-neutralLightGrayishBlue2 rounded-[4px] bg-white py-[10px] px-4 text-neutralDarkGrayishBlue text-[0.825rem] cursor-pointer leading-[1.25rem] hover:bg-neutralLightGrayishBlue1 hover:border-neutralLightGrayishBlue1">
